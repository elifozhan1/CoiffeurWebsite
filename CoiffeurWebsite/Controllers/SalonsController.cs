...
namespace CoiffeurWebsite.Controllers
{
    public class SalonsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SalonID,SalonName")] Salon salon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SalonID,SalonName")] Salon salon)
        {
            if (id != salon.SalonID)
            {
                return NotFound();
